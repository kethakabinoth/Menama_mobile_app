      ...
      <View style={styles.cardHeader}>
        ...
        <View style={{ alignItems: "flex-end" }}>
          ...
          <Text style={styles.timeAgoText}>
            {item.materials[0]?.Tr_Date
              ? getTimeAgo(item.materials[0].Tr_Date)
              : ""}
          </Text>
        </View>
      </View>
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.webDatePickerContent}>
              ...
              <View style={styles.webModalActionRow}>
                ...
                >
                  <Text style={{ color: G.dark, fontWeight: "600" }}>
                    Cancel
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                ...
                >
                  <Text style={{ color: G.white, fontWeight: "600" }}>
                    Apply
                  </Text>
                </TouchableOpacity>
              </View>
              ...
              >
                ...
                <View style={styles.materialTableModal}>
                  <View style={styles.materialTableHeader}>
                    <Text style={[styles.tableHead, { flex: 2 }]}>
                      Material
                    </Text>
                    <Text
                      style={[
